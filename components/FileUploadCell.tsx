  ...
  return (
    <div className="min-w-[140px]">
      {value ? (
        <div className="flex items-center gap-1.5">
          {isImage ? (
            ...
            <a
              ...
              className="flex items-center gap-1 rounded bg-[#FFFDE7] px-2 py-1 text-xs text-[#7a5c00] hover:bg-[#FFF3A0] border border-[#F5C400]/30"
            >
        ...
        <label className={`flex cursor-pointer items-center gap-1.5 rounded border border-dashed border-[#E5E3DC] px-2 py-1.5 text-xs text-gray-500 hover:border-[#F5C400]/50 hover:text-[#7a5c00] ${uploading ? "opacity-50 pointer-events-none" : ""}`}>
          {uploading ? (
            <>
